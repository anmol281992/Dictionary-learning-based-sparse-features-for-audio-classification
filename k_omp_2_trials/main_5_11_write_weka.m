...
trainFilename = [pwd '\' num2str(iter) 'k_omp' num2str(k_omp) '_features_train_' feature_name{j} '_clean.arff'];
testFilename = [pwd '\' num2str(iter) 'k_omp' num2str(k_omp) '_features_test_' feature_name{j} '_clean.arff'];
